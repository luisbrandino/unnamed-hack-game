            ...
            <div class="row text-center justify-content-center align-items-center">
                <div class="col-md-6 login-form-1">
                    ...
                    <h3 class="mb-4">Login</h3>
                          ...
                          <form id="login-form" action="actions/login.php" method="post" onsubmit="return checkFields(this)">
                        ...
                        <div class="form-group">
                            <a href="recover_password.php" class="btnForgetPwd">Forget Password?</a>
                        </div>
